...
const isType = (targetType, acceptType) => {
    if ((0, exports.isUndefined)(targetType) || (0, exports.isUndefined)(acceptType))
        return false;
    if (targetType.parent === LiteralTypes_1.default.IF_OPERATOR && acceptType.parent !== LiteralTypes_1.default.IF_OPERATOR)
        return false;
    if (targetType.parent === LiteralTypes_1.default.ANY && targetType.child === LiteralTypes_1.default.ANY)
        return true;
    if (acceptType.parent === LiteralTypes_1.default.ANY && acceptType.child === LiteralTypes_1.default.ANY)
        return true;
    if (targetType.parent === LiteralTypes_1.default.ANY)
        return true;
    if (targetType.parent === acceptType.parent && acceptType.child === LiteralTypes_1.default.ANY)
        return true;
...
const isTypeString = (targetType) => {
    if ((0, exports.isUndefined)(targetType))
        return false;
    if (targetType.parent === LiteralTypes_1.default.ANY && targetType.child === LiteralTypes_1.default.ANY)
        return true;
    if (targetType.parent === LiteralTypes_1.default.ANY)
...
const isTypeArray = (targetType) => {
    ...
    if (targetType.parent === LiteralTypes_1.default.ANY && targetType.child === LiteralTypes_1.default.ANY)
        return true;
    return !(0, exports.isUndefined)(targetType) && targetType.parent === LiteralTypes_1.default.ARRAY && targetType.child === LiteralTypes_1.default.NONE;
};
...
const isTypeArrayStrict = (targetType, acceptType) => {
    if ((0, exports.isUndefined)(targetType))
        return false;
    if ((0, exports.isUndefined)(acceptType))
        return false;
    if (targetType.parent === LiteralTypes_1.default.ANY && targetType.child === LiteralTypes_1.default.ANY)
        return true;
    if (acceptType.parent === LiteralTypes_1.default.ANY && acceptType.child === LiteralTypes_1.default.ANY)
        return true;
    if ((0, exports.isTypeArray)(targetType) && targetType.child === LiteralTypes_1.default.ANY)
        return true;
...
const isTypeIfOperator = (targetType) => {
    ...
    if (targetType.parent === LiteralTypes_1.default.ANY && targetType.child === LiteralTypes_1.default.ANY)
        return true;
    if (targetType.parent === LiteralTypes_1.default.ANY && targetType.child === LiteralTypes_1.default.NONE)
        return true;
